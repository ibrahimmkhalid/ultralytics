...
from sfdt_ibrahim.solutions.object_counter import ObjectCounter
...
class Heatmap(ObjectCounter):
    ...
    Examples:
        >>> from sfdt_ibrahim.solutions import Heatmap
    ...
    def generate_heatmap(self, im0):
        """
        Generate heatmap for each frame using SFDT_Ibrahim.
