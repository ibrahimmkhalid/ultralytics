...
from sfdt_ibrahim.utils import LOGGER
from sfdt_ibrahim.utils.checks import check_requirements
from sfdt_ibrahim.utils.downloads import GITHUB_ASSETS_STEMS


class Inference:
    """
    A class to perform object detection, image classification, image segmentation and pose estimation inference using
    Streamlit and SFDT_Ibrahim YOLO models. It provides the functionalities such as loading models, configuring settings,
    ...
    def __init__(self, **kwargs: Any):
        ...
        """
        check_requirements("streamlit>=1.29.0")  # scope imports for faster sfdt_ibrahim package load speeds
        ...
        LOGGER.info(f"SFDT_Ibrahim Solutions: ✅ {self.temp_dict}")
    ...
    def web_ui(self):
        ...
        font-family: 'Archivo', sans-serif; margin-bottom:20px;">SFDT_Ibrahim YOLO Streamlit Application</h1></div>"""

        # Subtitle of streamlit application
        sub_title_cfg = """<div><h4 style="color:#042AFF; text-align:center; font-family: 'Archivo', sans-serif; 
        margin-top:-15px; margin-bottom:50px;">Experience real-time object detection on your webcam with the power 
        of SFDT_Ibrahim YOLO! 🚀</h4></div>"""

        # Set html page configuration and append custom HTML
        self.st.set_page_config(page_title="SFDT_Ibrahim Streamlit App", layout="wide")
    ...
    def sidebar(self):
        ...
        with self.st.sidebar:  # Add SFDT_Ibrahim LOGO
            logo = "https://raw.githubusercontent.com/sfdt_ibrahim/assets/main/logo/SFDT_Ibrahim_Logotype_Original.svg"
    ...
    def source_upload(self):
        ...
        if self.source == "video":
            ...
            if vid_file is not None:
                ...
                with open("sfdt_ibrahim.mp4", "wb") as out:  # Open temporary file as bytes
                    out.write(g.read())  # Read bytes into file
                self.vid_file_name = "sfdt_ibrahim.mp4"
