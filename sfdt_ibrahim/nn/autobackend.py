...
from sfdt_ibrahim.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from sfdt_ibrahim.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from sfdt_ibrahim.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    """
    Handles dynamic backend selection for running inference using SFDT_Ibrahim YOLO models.
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from sfdt_ibrahim.nn.tasks import attempt_load_weights
        ...
        # TensorRT
            ...
            with open(w, "rb") as f, trt.Runtime(logger) as runtime:
                try:
                    ...
                    f.seek(0)  # engine file may lack embedded SFDT_Ibrahim metadata
        ...
        # TF GraphDef
            ...
            from sfdt_ibrahim.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from sfdt_ibrahim.utils.triton import TritonRemoteModel
        ...
        # Any other format (unsupported)
            ...
            from sfdt_ibrahim.engine.exporter import export_formats

            raise TypeError(
                f"model='{w}' is not a supported model format. SFDT_Ibrahim supports: {export_formats()['Format']}\n"
                f"See https://docs.sfdt_ibrahim.com/modes/predict for help."
            )
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        # CoreML
            ...
            if "confidence" in y:
                raise TypeError(
                    "SFDT_Ibrahim only supports inference of non-pipelined CoreML models exported with "
                    f"'nms=False', but 'model={w}' has an NMS pipeline created by an 'nms=True' export."
                )
                # TODO: CoreML NMS inference handling
                # from sfdt_ibrahim.utils.ops import xywh2xyxy
            ...
            if self.saved_model:  # SavedModel
                ...
                for output in self.output_details:
                    ...
                    if x.ndim == 3:  # if task is not classification, excluding masks (ndim=4) as well
                        # Denormalize xywh by image size. See https://github.com/sfdt_ibrahim/sfdt_ibrahim/pull/1695
