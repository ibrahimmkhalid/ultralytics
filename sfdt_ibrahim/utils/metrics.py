...
from sfdt_ibrahim.utils import LOGGER, SimpleClass, TryExcept, plt_settings
...
def smooth_bce(eps=0.1):
    ...
    For implementation details, refer to https://github.com/sfdt_ibrahim/yolov3/issues/238#issuecomment-598028441.
