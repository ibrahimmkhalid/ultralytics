...
from sfdt_ibrahim.utils.metrics import batch_probiou
...
def segment2box(segment, width=640, height=640):
    ...
    # any 3 out of 4 sides are outside the image, clip coordinates first, https://github.com/sfdt_ibrahim/sfdt_ibrahim/pull/18294
...
def masks2segments(masks, strategy="all"):
    ...
    """
    from sfdt_ibrahim.data.converter import merge_multi_segment
