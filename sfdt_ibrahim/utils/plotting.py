...
from sfdt_ibrahim.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from sfdt_ibrahim.utils.checks import check_font, check_version, is_ascii
from sfdt_ibrahim.utils.files import increment_path


class Colors:
    """
    SFDT_Ibrahim color palette https://docs.sfdt_ibrahim.com/reference/utils/plotting/#sfdt_ibrahim.utils.plotting.Colors.

    This class provides methods to work with the SFDT_Ibrahim color palette, including converting hex color codes to
    RGB values.
    ...
    !!! note "SFDT_Ibrahim Brand Colors"

        For SFDT_Ibrahim brand colors see [https://www.sfdt_ibrahim.com/brand](https://www.sfdt_ibrahim.com/brand). Please use the official SFDT_Ibrahim colors for all marketing materials.
    """
...
class Annotator:
    """
    SFDT_Ibrahim Annotator for train/val mosaics and JPGs and predictions annotations.
...
@TryExcept()  # known issue https://github.com/sfdt_ibrahim/yolov5/issues/5395
@plt_settings()
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    """Plot training labels including class histograms and box statistics."""
    import pandas  # scope for faster 'import sfdt_ibrahim'
    import seaborn  # scope for faster 'import sfdt_ibrahim'
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from sfdt_ibrahim.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/sfdt_ibrahim/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ...
        ```
    """
    import pandas as pd  # scope for faster 'import sfdt_ibrahim'
