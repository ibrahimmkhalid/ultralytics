...
Usage:
    from sfdt_ibrahim.utils.benchmarks import ProfileModels, benchmark
...
from sfdt_ibrahim import YOLO, YOLOWorld
from sfdt_ibrahim.cfg import TASK2DATA, TASK2METRIC
from sfdt_ibrahim.engine.exporter import export_formats
from sfdt_ibrahim.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from sfdt_ibrahim.utils.checks import IS_PYTHON_3_12, check_imgsz, check_requirements, check_yolo, is_rockchip
from sfdt_ibrahim.utils.downloads import safe_download
from sfdt_ibrahim.utils.files import file_size
from sfdt_ibrahim.utils.torch_utils import get_cpu_info, select_device
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt="datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("sfdt_ibrahim-benchmarks")
        safe_download("https://github.com/sfdt_ibrahim/assets/releases/download/v0.0.0/datasets_links.txt")
