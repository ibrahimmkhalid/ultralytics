...
from sfdt_ibrahim.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/sfdt_ibrahim/sfdt_ibrahim/pull/4674
    ...
    from sfdt_ibrahim.utils.torch_utils import de_parallel, torch
