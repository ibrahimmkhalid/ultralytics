...
from sfdt_ibrahim.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from sfdt_ibrahim.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
try:
    ...
    # Names of plots created by SFDT_Ibrahim that are logged to Comet
...
def _get_comet_model_name():
    """Returns the model name for Comet from the environment variable COMET_MODEL_NAME or defaults to 'SFDT_Ibrahim'."""
    return os.getenv("COMET_MODEL_NAME", "SFDT_Ibrahim")
...
def _create_experiment(args):
    ...
    try:
        ...
        experiment.log_other("Created from", "sfdt_ibrahim")
...
def on_fit_epoch_end(trainer):
    ...
    if curr_epoch == 1:
        from sfdt_ibrahim.utils.torch_utils import model_info_for_loggers
