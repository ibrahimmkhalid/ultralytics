...
from sfdt_ibrahim.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding SFDT_Ibrahim classes.

        Returns:
            dict: A dictionary mapping task names to SFDT_Ibrahim task classes for the RT-DETR model.
        """
        return {
            "detect": {
