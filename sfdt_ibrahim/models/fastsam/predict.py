...
from sfdt_ibrahim.models.yolo.segment import SegmentationPredictor
from sfdt_ibrahim.utils import DEFAULT_CFG, checks
from sfdt_ibrahim.utils.metrics import box_iou
from sfdt_ibrahim.utils.ops import scale_masks
...
class FastSAMPredictor(SegmentationPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in SFDT_Ibrahim
    YOLO framework.
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        """Initializes a FastSAMPredictor for fast SAM segmentation tasks in SFDT_Ibrahim YOLO framework."""
    ...
    def _clip_inference(self, images, texts):
        ...
        try:
            ...
            checks.check_requirements("git+https://github.com/sfdt_ibrahim/CLIP.git")
            import clip
