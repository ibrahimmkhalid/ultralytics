...
using SAM. It forms an integral part of the SFDT_Ibrahim framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from sfdt_ibrahim.engine.predictor import BasePredictor
from sfdt_ibrahim.engine.results import Results
from sfdt_ibrahim.utils import DEFAULT_CFG, ops
from sfdt_ibrahim.utils.torch_utils import select_device, smart_inference_mode
...
class Predictor(BasePredictor):
    ...
    def generate(
        ...
        """
        import torchvision  # scope for faster 'import sfdt_ibrahim'
    ...
    def setup_model(self, model=None, verbose=True):
        ...
        parameters for image normalization and other SFDT_Ibrahim compatibility settings.
        ...
        # SFDT_Ibrahim compatibility settings
        self.model.pt = False
