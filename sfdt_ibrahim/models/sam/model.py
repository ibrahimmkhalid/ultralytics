...
This module provides an interface to the Segment Anything Model (SAM) from SFDT_Ibrahim, designed for real-time image
...
from sfdt_ibrahim.engine.model import Model
from sfdt_ibrahim.utils.torch_utils import model_info
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from SFDT_Ibrahim, designed for
    ...
    def task_map(self):
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': <class 'sfdt_ibrahim.models.sam.predict.Predictor'>}
        """
