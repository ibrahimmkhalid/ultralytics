...
from sfdt_ibrahim.utils.checks import check_file, check_font, is_ascii
from sfdt_ibrahim.utils.downloads import download, safe_download, unzip_file
from sfdt_ibrahim.utils.ops import segments2boxes

HELP_URL = "See https://docs.sfdt_ibrahim.com/datasets for dataset formatting guidance."
...
def check_cls_dataset(dataset, split=""):
    ...
    if not data_dir.is_dir():
        ...
        if str(dataset) == "imagenet":
            ...
            url = f"https://github.com/sfdt_ibrahim/assets/releases/download/v0.0.0/{dataset}.zip"
...
class HUBDatasetStats:
    ...
    Example:
        Download *.zip files from https://github.com/sfdt_ibrahim/hub/tree/main/example_datasets
            i.e. https://github.com/sfdt_ibrahim/hub/raw/main/example_datasets/coco8.zip for coco8.zip.
        ```python
        from sfdt_ibrahim.data.utils import HUBDatasetStats
    ...
    def get_json(self, save=False, verbose=False):
        """Return dataset JSON for SFDT_Ibrahim HUB."""
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                from torchvision.datasets import ImageFolder  # scope for faster 'import sfdt_ibrahim'
                ...
                from sfdt_ibrahim.data import YOLODataset
    ...
    def process_images(self):
        """Compress images for SFDT_Ibrahim HUB."""
        from sfdt_ibrahim.data import YOLODataset  # ClassificationDataset
...
def load_dataset_cache_file(path):
    """Load an SFDT_Ibrahim *.cache dictionary from path."""
    import gc

    gc.disable()  # reduce pickle load time https://github.com/sfdt_ibrahim/sfdt_ibrahim/pull/1585
...
def save_dataset_cache_file(prefix, path, x, version):
    """Save an SFDT_Ibrahim dataset *.cache dictionary x to path."""
