...
from sfdt_ibrahim.data.utils import polygons2masks, polygons2masks_overlap
from sfdt_ibrahim.utils import LOGGER, colorstr
from sfdt_ibrahim.utils.checks import check_version
from sfdt_ibrahim.utils.instance import Instances
from sfdt_ibrahim.utils.metrics import bbox_ioa
from sfdt_ibrahim.utils.ops import segment2box, xyxyxyxy2xywhr
from sfdt_ibrahim.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class BaseTransform:
    """
    Base class for image transformations in the SFDT_Ibrahim library.
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from sfdt_ibrahim.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from sfdt_ibrahim.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from sfdt_ibrahim.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        values and labels. This implementation is designed for use with the SFDT_Ibrahim YOLO framework.
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from sfdt_ibrahim.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (sfdt_ibrahim.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (sfdt_ibrahim.utils.instance.Instances): Updated instances matching the flipped image.
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from sfdt_ibrahim.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from sfdt_ibrahim.data.dataset import YOLODataset
        >>> from sfdt_ibrahim.utils import IterableSimpleNamespace
...
def classify_transforms(
    ...
    """
    import torchvision.transforms as T  # scope for faster 'import sfdt_ibrahim'
...
class ToTensor:
    ...
    def __init__(self, half=False):
        ...
        SFDT_Ibrahim YOLO framework. It converts numpy arrays or PIL Images to PyTorch tensors, with an option
