...
"""
SFDT_Ibrahim Results, Boxes and Masks classes for handling inference results.

Usage: See https://docs.sfdt_ibrahim.com/modes/predict/
"""
...
from sfdt_ibrahim.data.augment import LetterBox
from sfdt_ibrahim.utils import LOGGER, SimpleClass, ops
from sfdt_ibrahim.utils.checks import check_requirements
from sfdt_ibrahim.utils.plotting import Annotator, colors, save_one_box
from sfdt_ibrahim.utils.torch_utils import smart_inference_mode
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from sfdt_ibrahim.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Masks(BaseTensor):
    ...
    def __init__(self, masks, orig_shape) -> None:
        ...
        Examples:
            >>> import torch
            >>> from sfdt_ibrahim.engine.results import Masks
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from sfdt_ibrahim.engine.results import Keypoints
