...
from sfdt_ibrahim.cfg import TASK2DATA, get_cfg, get_save_dir
from sfdt_ibrahim.engine.results import Results
from sfdt_ibrahim.hub import HUB_WEB_ROOT, HUBTrainingSession
from sfdt_ibrahim.nn.tasks import (
...
class Model(torch.nn.Module):
    ...
    loaded from local files, SFDT_Ibrahim HUB, or Triton Server.
    ...
    Attributes:
        ...
        session (HUBTrainingSession): The SFDT_Ibrahim HUB session, if applicable.
    ...
    def __init__(
        ...
        model sources, including local files, SFDT_Ibrahim HUB models, and Triton Server models. The method
        ...
        Args:
            model (Union[str, Path]): Path or name of the model to load or create. Can be a local file path, a
                model name from SFDT_Ibrahim HUB, or a Triton Server model.
        ...
        # Check if SFDT_Ibrahim HUB model from https://hub.sfdt_ibrahim.com
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        Returns:
            (List[sfdt_ibrahim.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.
    ...
    def is_hub_model(model: str) -> bool:
        """
        Check if the provided model is an SFDT_Ibrahim HUB model.

        This static method determines whether the given model string represents a valid SFDT_Ibrahim HUB model
        identifier.
        ...
        Returns:
            (bool): True if the model is a valid SFDT_Ibrahim HUB model, False otherwise.

        Examples:
            >>> Model.is_hub_model("https://hub.sfdt_ibrahim.com/models/MODEL")
            True
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        the date, SFDT_Ibrahim version, license information, and a link to the documentation.
        ...
        updates = {
            ...
            "version": __version__,
            "license": "AGPL-3.0 License (https://sfdt_ibrahim.com/license)",
    ...
    def embed(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> image = "https://sfdt_ibrahim.com/images/bus.jpg"
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("sfdt_ibrahim")) and any(
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        Returns:
            (List[sfdt_ibrahim.engine.results.Results]): A list of tracking results, each a Results object.
        ...
        if not hasattr(self.predictor, "trackers"):
            from sfdt_ibrahim.trackers import register_tracker
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        Args:
            validator (sfdt_ibrahim.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs: Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (sfdt_ibrahim.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs: Any,
        ...
        It uses the 'benchmark' function from the sfdt_ibrahim.utils.benchmarks module. The benchmarking is
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        from a checkpoint, integrating with SFDT_Ibrahim HUB, and updating model and configuration after training.

        When using SFDT_Ibrahim HUB, if the session has a loaded model, the method prioritizes HUB training
        ...
        ):  # SFDT_Ibrahim HUB session with loaded model
            if any(kwargs):
                LOGGER.warning(
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the sfdt_ibrahim.utils.tuner module.
    ...
    def names(self) -> Dict[int, str]:
        ...
        using the 'check_class_names' function from the sfdt_ibrahim.nn.autobackend module. If the predictor is not
        ...
        """
        from sfdt_ibrahim.nn.autobackend import check_class_names
    ...
    def clear_callback(self, event: str) -> None:
        ...
        Args:
            event (str): The name of the event for which to clear the callbacks. This should be a valid event name
                recognized by the SFDT_Ibrahim callback system.
        ...
        Notes:
            - This method affects both custom callbacks added by the user and default callbacks
              provided by the SFDT_Ibrahim framework.
    ...
    def task_map(self) -> dict:
        ...
        various tasks and modes within the SFDT_Ibrahim framework.
        ...
        Note:
            ...
            classes supported by the SFDT_Ibrahim framework. The docstring provides a general
