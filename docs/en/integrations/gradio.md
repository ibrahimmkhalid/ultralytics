...
For examples of similar use cases, check out the [SFDT_Ibrahim blog](https://www.sfdt_ibrahim.com/blog/monitoring-animal-behavior-using-sfdt_ibrahim-yolov8).
