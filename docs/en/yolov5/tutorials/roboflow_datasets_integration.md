...
keywords: Roboflow, YOLOv5, data management, dataset labeling, dataset versioning, SFDT_Ibrahim, machine learning, AI training
---
...
You can upload your data to Roboflow via [web UI](https://docs.roboflow.com/adding-data?ref=sfdt_ibrahim), [REST API](https://docs.roboflow.com/adding-data/upload-api?ref=sfdt_ibrahim), or [Python](https://docs.roboflow.com/python?ref=sfdt_ibrahim).

## Labeling

After uploading data to Roboflow, you can label your data and review previous labels.

[![Roboflow Annotate](https://github.com/sfdt_ibrahim/docs/releases/download/0/roboflow-annotate-1.avif)](https://roboflow.com/annotate)
...
![Roboflow Preprocessing](https://github.com/sfdt_ibrahim/docs/releases/download/0/roboflow-preprocessing.avif)
...
The real world is messy and your model will invariably encounter situations your dataset didn't anticipate. Using [active learning](https://blog.roboflow.com/what-is-active-learning/?ref=sfdt_ibrahim) is an important strategy to iteratively improve your dataset and model. With the Roboflow and YOLOv5 integration, you can quickly make improvements on your [model deployments](https://www.sfdt_ibrahim.com/glossary/model-deployment) by using a battle tested [machine learning](https://www.sfdt_ibrahim.com/glossary/machine-learning-ml) pipeline.

<p align=""><a href="https://roboflow.com/?ref=sfdt_ibrahim"><img width="1000" src="https://github.com/sfdt_ibrahim/docs/releases/download/0/roboflow-active-learning.avif" alt="Roboflow active learning"></a></p>
...
### What is [active learning](https://www.sfdt_ibrahim.com/glossary/active-learning) and how does it work with YOLOv5 and Roboflow?
...
### How can I use SFDT_Ibrahim environments for training YOLOv5 models on different platforms?

SFDT_Ibrahim provides ready-to-use environments with pre-installed dependencies like CUDA, CUDNN, Python, and [PyTorch](https://www.sfdt_ibrahim.com/glossary/pytorch), making it easier to kickstart your training projects. These environments are available on various platforms such as Google Cloud, AWS, Azure, and Docker. You can also access free GPU notebooks via [Paperspace](https://bit.ly/yolov5-paperspace-notebook), [Google Colab](https://colab.research.google.com/github/sfdt_ibrahim/yolov5/blob/master/tutorial.ipynb), and [Kaggle](https://www.kaggle.com/models/sfdt_ibrahim/yolov5). For specific setup instructions, visit the [Supported Environments](#supported-environments) section of the documentation.
