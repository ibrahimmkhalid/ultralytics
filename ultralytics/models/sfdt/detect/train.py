...
class DetectionTrainer(BaseTrainer):
    ...
    Example:
        ```python
        from ultralytics.models.sfdt.detect import DetectionTrainer

        args = dict(model="sfdt11n.pt", data="coco8.yaml", epochs=3)
    ...
    def get_validator(self):
        """Returns a DetectionValidator for SFDT model validation."""
        self.loss_names = "box_loss", "cls_loss", "dfl_loss"
        return sfdt.detect.DetectionValidator(
            self.test_loader,
    ...
    def plot_training_labels(self):
        """Create a labeled training plot of the SFDT model."""
