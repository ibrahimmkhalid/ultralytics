...
class DetectionValidator(BaseValidator):
    ...
    Example:
        ```python
        from ultralytics.models.sfdt.detect import DetectionValidator

        args = dict(model="sfdt11n.pt", data="coco8.yaml")
    ...
    def preprocess(self, batch):
        """Preprocesses batch of images for SFDT training."""
    ...
    def init_metrics(self, model):
        """Initialize evaluation metrics for SFDT."""
    ...
    def get_desc(self):
        """Return a formatted string summarizing class metrics of SFDT model."""
        return ("%22s" + "%11s" * 6) % (
            "Class",
            "Images",
            "Instances",
    ...
    def save_one_txt(self, predn, save_conf, shape, file):
        """Save SFDT detections to a txt file in normalized coordinates in a specific format."""
    ...
    def pred_to_json(self, predn, filename):
        """Serialize SFDT predictions to COCO json format."""
    ...
    def eval_json(self, stats):
        """Evaluates SFDT output in JSON format and returns performance statistics."""
